...
class Simulation(ABC):
    ...
    def get_neighbors(self, distance=0.00002):
        ...
        bins, bins_help, bin_locations, max_cells = self.assign_bins(distance, Simulation.get_neighbors.max_cells)

        # update the value of the max number of cells in a bin
        Simulation.get_neighbors.max_cells = max_cells
        ...
        while True:
            ...
            length = self.number_agents * Simulation.get_neighbors.max_neighbors
            ...
            if self.parallel:
                ...
                max_neighbors = cuda.to_device(Simulation.get_neighbors.max_neighbors)
            ...
            # call the jit cpu version
                ...
                edge_holder, if_edge, edge_count = get_neighbors_cpu(self.number_agents, bin_locations, self.locations,
                                                                     ...
                                                                     edge_count,
                                                                     Simulation.get_neighbors.max_neighbors)
            ...
            if Simulation.get_neighbors.max_neighbors >= max_neighbors:
                break
            else:
                Simulation.get_neighbors.max_neighbors = max_neighbors * 2
